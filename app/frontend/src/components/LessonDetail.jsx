      ...
      <div className="min-h-screen bg-gray-50 relative flex items-center justify-center">
        ...
        <div className="text-center">
          ...
          <button 
            ...
            className="mt-4 px-6 py-2 bg-[#344F1F] text-white rounded-lg hover:bg-[#2a3f1a]"
          >
            Back to Learning
          </button>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-xl font-semibold text-gray-900">{lesson.lesson.title}</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {!showQuiz ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            {/* Summary */}
            <div className="bg-[#FFECC0] rounded-lg p-6 mb-8">
              <h3 className="text-lg font-semibold text-[#344F1F] mb-4 flex items-center gap-2">
              ...
              <ul className="space-y-2">
                {lesson.lesson.summary.map((point, index) => (
                  <li key={index} className="flex items-start gap-2 text-gray-700">
                    <CheckCircle className="w-5 h-5 text-[#344F1F] mt-0.5 flex-shrink-0" />
                    <span>{point}</span>
                  </li>
                ))}
              </ul>

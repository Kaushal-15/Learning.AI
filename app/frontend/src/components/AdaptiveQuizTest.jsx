    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Adaptive MCQ System Test</h1>
            <p className="text-gray-600">Test the real-time difficulty adaptation system</p>
          </div>
        </div>
              ...
              >
                ...
                {result.data && (
                  <div className="bg-gray-50 rounded p-4">
                    <p className="text-gray-700 text-sm font-medium mb-2">Test Data:</p>
                    
                    {result.data.adaptiveChange && (
                      <div className="mb-3 p-3 bg-blue-50 border border-blue-200 rounded">
                        <p className="text-blue-800 font-medium">Adaptive Change Detected:</p>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-blue-900 mb-3">How Adaptive System Works</h3>
